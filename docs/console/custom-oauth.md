...
![自定义 OAuth 提供商列表](./assets/custom-oauth-provider-list.png)

## 添加自定义 OAuth 提供商

1. 点击「添加提供商」按钮，弹出配置弹窗

![添加自定义 OAuth 弹窗](./assets/custom-oauth-add-modal.png)
...
![自动发现填充后的配置项](./assets/custom-oauth-discovery-filled.png)
